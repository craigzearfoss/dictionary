...
@section('content')
    ...
    <div class="row mt-2">
        <div class="col-8">
            <h1 class="page-title">{{ $method === 'post' ? 'Create' : 'Edit' }} a Tag</h1>
        </div>
    ...
    <div class="row">
        <div class="container form-container" style="max-width: 30rem;">
            ...
            <form id="frmTag" class="admin-form" action="{{ $action }}" method="{{ $method }}">
                @csrf
                @if ($method == 'put')
                    @method('PUT')
                @endif
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="name" id="name" value="{{ $tag->name }}" placeholder="">
                </div>
                ...
                <div class="mb-3">
                    <div class="form-check form-switch">
                        ...
                        <input class="form-check-input" type="checkbox" role="switch" name="active" id="active" value="1"
                           {{ $method === 'post' || $tag->active ? 'checked' : '' }}
                        >
                ...
                <div class="row mt-3">
                    <div class="col-12 text-end">
                        <a class="btn btn-sm btn-primary" href="{{ route('admin.tag.index') }}" style="width: 5rem;">Cancel</a>
                ...
                <div class="row">
                    <div class="container success-container text-center mt-4 hidden" style="max-width: 40rem;">
                        ...
                        @if ($method == 'put')
                            <a id="reedit-btn" class="btn btn-sm btn-primary" href="{{ route('admin.tag.edit', $tag->id) }}">Re-Edit</a>
                        @else
                            <a id="reedit-btn" class="btn btn-sm btn-primary" href="{{ route('admin.tag.edit', '##') }}">Re-Edit</a>
                        @endif
    ...
    <script type="text/javascript">
        ...
        const validationMessages = {
            name: {
                ...
                maxlength: "Tag name can be no longer than 50 characters.",
            }
        };
