...
@section('content')
    ...
    <div class="row mt-2">
        <div class="col-8">
            <h1 class="page-title">{{ $language->name }} Translations</h1>
        </div>
        ...
        <div class="container" style="max-width: 60rem;">
            ...
            <div class="row">
                <div class="col">
                    ...
                    <form class="filter-form d-flex" id="frmFilter" action="{{ route('admin.translate.index', $language->code) }}" method="get">
                            ...
                            @foreach ($data as $key => $value)
                                <tr data-id="{{ $value->id }}">
                                    ...
                                    <td class="actions-cell text-end">
                                        <a class="btn btn-sm btn-primary" href="{{ route('admin.translate.show', [$language->code, $value->id]) }}">Show</a>
                                    </td>
                                </tr>
                            @endforeach
