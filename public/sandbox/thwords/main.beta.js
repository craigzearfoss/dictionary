    ...
    (this.thword.bundle = (function (e) {
        ...
        function addObjectsAsProperties(obj, objectsToAdd) {
            for (var s = 0; s < a.length; s++) {
                var t = objectsToAdd[s];
                (t.enumerable = t.enumerable || !1), (t.configurable = !0), "value" in t && (t.writable = !0), Object.defineProperty(obj, t.key, t);
            }
        }

        function o(obj, a, s) {
            return a && addObjectsAsProperties(obj.prototype, a), s && addObjectsAsProperties(obj, s), obj;
        }
        ...
        function isInitialized(obj) {
            if (void 0 === obj) throw new ReferenceError("this hasn't been initialised - super() hasn't been called");
            return obj;
        }
...
`;
        ...
        let rowTemplate = document.createElement("template");
...
`;
                ...
                o(
                    ...
                    [
                        ...
                        },
                        {
                            ...
                            value: function () {
                                var e = this;
                                this.shadowRoot.appendChild(rowTemplate.content.cloneNode(!0)), (this.$row = this.shadowRoot.querySelector(".row"));
                                for (
                                    var a = function (a) {
        ...
        let slotTemplate = document.createElement("template");
...
`;
            ...
            return (
                o(t, [
                    ...
                    },
                    {
                        ...
                        value: function () {
                            var e = this;
                            this.shadowRoot.appendChild(slotTemplate.content.cloneNode(!0)),
        ...
        let fe = be ? be.allocUnsafe : void 0;
        ...
        let He = $e && $e.exports === Pe ? I.Buffer : void 0;
...
`;
        ...
        let gameToast = (function (e) {
            ...
            function t() {
                var e;
                return isInstanceOf(this, t), n(p((e = a.call(this))), "_duration", void 0), e.attachShadow({ mode: "open" }), e;
            }
            return (
                o(t, [
                    {
        ...
        let Ra = { unknown: 0, absent: 1, present: 2, correct: 3 };;
                ...
                o(t, [
                    {
                        ...
                        value: function () {
                            if (5 === this.tileIndex && !(this.rowIndex >= 6)) {
                                ...
                                if (((e = s), !invalidWordsArray.includes(e) && !La.includes(e))) return a.setAttribute("invalid", ""), void this.addToast("Not in word list");
                                if (this.hardMode) {
                                ...
                                if (i || l)
                                    Va({ isWin: l, isStreak: !!this.lastCompletedTs && 1 === Na(new Date(this.lastCompletedTs), new Date()), numGuesses: this.rowIndex }),
                                        ...
                                        (this.gameStatus = l ? winStatus : failStatus),
                ...
                o(t, [
                    {
                        ...
                        value: function () {
                            ...
                            if (
                                ...
                                var m = countdownTemplate.content.cloneNode(!0);
                                p.appendChild(m),
                ...
                o(t, [
                    {
                        ...
                        value: function () {
                            ...
                            "backspace" === iconName && this.shadowRoot.querySelector("path").setAttribute("fill", "var(--color-tone-1)"),
                            "share" === iconName && this.shadowRoot.querySelector("path").setAttribute("fill", "var(--white)");
                        },
                    },
                ]),
                t
